...
function is31Flavors(copyArray2){
  if (copyArray2.length === 31) {
    return true
  } else {
    return false
  }
...
function addFlavor(getArray, flavor){
 getArray.unshift(flavor)
 return getArray
}
...
function removeLastFlavor(getArray2){
  getArray2.pop()
  return getArray2
}
...
function getFlavorByIndex(array3, num){
  return array3[num]
}
...
function removeFlavorByName(array4, flavor){

  let removeIt = array4.indexOf(flavor)
  array4.splice(removeIt, 1)
  return array4
}
